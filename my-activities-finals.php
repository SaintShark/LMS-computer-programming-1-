...
// Set page title for Finals
$pageTitle = 'My Activities - Finals';
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="card-title">Finals Activities List</h5>
                        </div>
...
<script>
    ...
    window.periodFilter = 'finals'; // Fixed to finals for this page
